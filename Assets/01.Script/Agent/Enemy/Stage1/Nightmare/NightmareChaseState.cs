...
public class NightmareChaseState : EnemyState
{
    public NightmareChaseState(Enemy enemy, EnemyStateMachine stateMachine, string animBoolName) : base(enemy, stateMachine, animBoolName)
    {
    }
