...
public class EvilWizardChaseState : EnemyState
{
    public EvilWizardChaseState(Enemy enemy, EnemyStateMachine stateMachine, string animBoolName) : base(enemy, stateMachine, animBoolName)
    {
    }
