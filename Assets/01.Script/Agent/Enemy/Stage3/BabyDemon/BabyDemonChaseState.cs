...
public class BabyDemonChaseState : EnemyState
{
    public BabyDemonChaseState(Enemy enemy, EnemyStateMachine stateMachine, string animBoolName) : base(enemy, stateMachine, animBoolName)
    {
    }
