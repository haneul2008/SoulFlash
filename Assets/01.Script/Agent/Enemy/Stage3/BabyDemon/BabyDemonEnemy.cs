...
public class BabyDemonEnemy : Enemy
{
    ...
    protected override void Awake()
    {
        ...
        stateMachine.AddState(EnemyEnum.Idle, new BabyDemonIdleState(this, stateMachine, "Idle"));
        stateMachine.AddState(EnemyEnum.Chase, new BabyDemonChaseState(this, stateMachine, "Chase"));
        stateMachine.AddState(EnemyEnum.Attack, new BabyDemonAttackState(this, stateMachine, "Attack"));
