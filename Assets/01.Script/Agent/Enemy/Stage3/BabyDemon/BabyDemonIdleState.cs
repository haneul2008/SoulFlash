...
public class BabyDemonIdleState : EnemyState
{
    private Collider2D _player;
    public BabyDemonIdleState(Enemy enemy, EnemyStateMachine stateMachine, string animBoolName) : base(enemy, stateMachine, animBoolName)
    {
    }
