...
public class SoulSkeletonDeadState : EnemyState
{
    public SoulSkeletonDeadState(Enemy enemy, EnemyStateMachine stateMachine, string animBoolName) : base(enemy, stateMachine, animBoolName)
    {
    }
