...
public class TutorialFrogAttackState : BossState
{
    public TutorialFrogAttackState(Boss boss, BossStateMachine stateMachine, string animBoolName) : base(boss, stateMachine, animBoolName)
    {
    }
