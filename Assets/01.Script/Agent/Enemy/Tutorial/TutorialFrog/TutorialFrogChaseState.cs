...
public class TutorialFrogChaseState : BossState
{
    public TutorialFrogChaseState(Boss boss, BossStateMachine stateMachine, string animBoolName) : base(boss, stateMachine, animBoolName)
    {
    }
